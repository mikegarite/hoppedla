<?php
		...
		vc_add_param("vc_row", array(
														...
														"id_hidden" => "ru_on_h",
														"value" => 0,
														"ism_label" => "For Registered Users",
														"aditional_info" => "",
														'group' => 'Indeed Social Locker',											
		));
		...
		vc_add_param("vc_row", array(
														"type" => "ism_show_hide",
														"param_name" => "ru_sh",
														"onClick_function" => "check_and_h_sh",
														"id_hidden" => "ru_sh_h",
														"value" => "hide",
														"ism_label" => "Display Locker?",
														"aditional_info" => "",
														'group' => 'Indeed Social Locker',
		));		
		...
		vc_add_param("vc_row", array(
														...
														"id_hidden" => "uhc_on_h",
														"value" => 0,
														"ism_label" => "For Users hac commented",
														"aditional_info" => "",
														'group' => 'Indeed Social Locker',
		));
		...
		vc_add_param("vc_row", array(
														...
														"id_hidden" => "ur_h",
														"value" => 0,
														"ism_label" => "For Users with specific Role",
														"aditional_info" => "",
														'group' => 'Indeed Social Locker',
		));
		
		vc_add_param("vc_row", array(
														"type" => "ism_roles_select",
														"param_name" => "ur_val",
														"id_hidden" => "ur_val_h",
														"value" => '',
														"ism_label" => "",
		...
		vc_add_param("vc_row", array(
														...
														"id_hidden" => "ref_h",
														"value" => 0,
														"ism_label" => "For Users from specific Ref",
														"aditional_info" => "",
														'group' => 'Indeed Social Locker',
		));
		vc_add_param("vc_row", array(
														"type" => "ism_select_referers",
														"param_name" => "ref_val",
														"id_hidden" => "ref_val_h",
														"value" => '',
														"ism_label" => "Select Ref:",
														"aditional_info" => "",
														'group' => 'Indeed Social Locker',
		));		
		vc_add_param("vc_row", array(
