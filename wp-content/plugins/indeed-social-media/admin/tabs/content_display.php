...
?>
        ...
        <div class="stuffbox-ism">
            <h3>
                <label>Disable On List Posts:</label>
            </h3>
            <div class="inside" style="padding-top: 10px;">
            
    	    	<label>
    	        	<?php $checked = (!empty($meta_arr['id_display_only_in_single'])) ? "checked" : ""; ?>
    	            <input type="checkbox" class="ism-switch" onClick="check_and_h(this, '#id_display_only_in_single');" <?php echo $checked;?> />
    	            <div class="switch" style="display:inline-block;"></div>
    	        </label> 
    	        <input type="hidden" value="<?php echo $meta_arr['id_display_only_in_single'];?>" name="id_display_only_in_single" id="id_display_only_in_single" /> 
