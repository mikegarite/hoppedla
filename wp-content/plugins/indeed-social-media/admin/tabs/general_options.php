	...
	<div class="stuffbox-ism">
        ...
        <div class="stuffbox-ism">
            ...
            <div class="inside">
				...
				<br/>
				<span class="ism-info" style="font-size:12px;">For a proper share and tracking the share counts on FaceBook you need to set a Facebook App ID. <strong>The FaceBook App ID is mandatory for "Social Locker" and "Custom Content Share" feature!</strong>. For a Standard Share Action it's <strong>NOT</strong> requested.</span>
                <span class="ism-info"></span>
				<span class="ism-info" style="padding-top:15px; font-weight:bold; font-size:12px;">Be sure that the FaceBook App is set properly (follow the Documentation guidelines)!<span> 
				<span class="ism-info" style="padding-top:15px; font-weight:bold; color:#b9201c; font-size:12px;">If you receive an error into the FaceBook Share Popup: "An error occurred. Please try again later." means :</span>
				<span class="ism-info">
				<ul style="list-style: inherit; padding: 0px 30px; font-weight:bold; font-size:12px; line-height:15px;">
				<li>You have another FaceBook script into your page that includes an incompatible (or an old) FaceBook Library or use another FaceBook App ID.</li>
				<li>The Facebook App is not set properly or is not able to connect with your Website.</li>
				</ul>
				</span>
				<div class="submit">
                    <input type="submit" value="Save changes" name="g_submit_bttn" class="button button-primary button-large" />
			                ...
			                <table class="" style="margin-bottom: 0px;">
			        	        <tbody>
			                        <tr valign="middle">
			                            ...
			                            <td>
			                            	Counts: <input type="number" value="" name="the_counts" style="width: 60px;" min="0" />
			                            </td>
			                            <td>
			                    ...
			                    <tr>
			                    	<td rowspan="4">
			                    		...
			                    		<?php
											...
											<?php
				                    			$str = '';
				                    			$ism_list = ism_return_general_labels_sm('long_keys', TRUE, '', TRUE, TRUE);
				                    			foreach ($arr as $k=>$v){
				                    				if ($v!=''){
       ...
       <div class="stuffbox-ism">
        ...
        <div class="stuffbox-ism">
            ...
            <div class="inside">
                <table class="form-table custom-labels" style="margin-bottom: 0px; width: 23%; margin-right:1%; border-right:1px solid #ddd; border-bottom: 1px solid #ddd;">
        	        <tbody>
        	        	<tr>
        	        		<td></td>
        	        		<td>Labels</td>
        	        	...
        	        	<?php 
        	        		$ism_list = ism_return_general_labels_sm('', TRUE, '', TRUE, TRUE);
        	        		$limit = ceil(count($ism_list)/4);
							$ik = 1;
							$i = 1;
        	        		foreach ($ism_list as $k=>$v){
        	        			?>
		  							<tr valign="middle">
					                    ...
					                    <td>
					                    	<input type="text" name="ism_general_sm_labels[<?php echo $v['long_key'];?>]" value="<?php echo $v['label'];?>"/>
					                    </td>
					                    <td>
					                    	<input type="number" name="ism_order[<?php echo $v['long_key'];?>]" value="<?php if(isset($meta_arr['ism_order'][$v['long_key']]) )echo $meta_arr['ism_order'][$v['long_key']];else echo $i;?>" style="width: 51px;" min="1" />
					                    </td>
					                </tr>        	    
        	        			<?php
								$ik++;
			    ...
			    <div class="ism-info" style="margin-top:20px;">
