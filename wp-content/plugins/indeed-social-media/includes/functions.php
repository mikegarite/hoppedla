...
function ism_return_sm_arr_ready($meta_arr, $attr){
	...
	if(strpos($meta_arr['list'], 'tw')!==FALSE){
        ...
        if ($meta_arr['display_counts']=='true'){
        	$args['display_counts'] = true;
        	////////////// for the moment twitter decide not to show the share counts, so we print counts from statistics
	...
	if(strpos($meta_arr['list'], 'amazon')!==FALSE){
		...
		$args = array();
		$args['link'] = 'http://www.amazon.com/gp/wishlist/static-add?u=' . $attr['url'] . '&t=' . $attr['post_title'];
		$args['new_window'] = true;
		$args['sm_type'] = $key;
		$args['sm_class'] = $long_key;
		if(isset($meta_arr['after_share_enable']) && $meta_arr['after_share_enable']==1){
	...
	if(strpos($meta_arr['list'], 'newsvine')!==FALSE){
		...
		$args = array();
		$args['link'] = 'http://www.newsvine.com/_tools/seed&save?u=' . $attr['url'] . '&h=' . $attr['post_title'];
		$args['new_window'] = true;
		$args['sm_type'] = $key;
		$args['sm_class'] = $long_key;
		if(isset($meta_arr['after_share_enable']) && $meta_arr['after_share_enable']==1){
	...
	if(strpos($meta_arr['list'], 'viadeo')!==FALSE){
		...
		$args = array();
		$args['link'] = 'http://www.viadeo.com/shareit/share/?url=' . $attr['url'] . '&title=' . $attr['post_title'];
		$args['new_window'] = true;
		$args['sm_type'] = $key;
		$args['sm_class'] = $long_key;
		if(isset($meta_arr['after_share_enable']) && $meta_arr['after_share_enable']==1){
	...
	if(strpos($meta_arr['list'], 'douban')!==FALSE){
		...
		$args = array();
		$args['link'] = 'http://www.douban.com/share/service?name=&href=' . $attr['url'] . '&image=' . $attr['feat_img'] .'&updated=&bm=&url=' . $attr['url'] . '&title=' . $attr['post_title'];
		$args['new_window'] = true;
		$args['sm_type'] = $key;
		$args['sm_class'] = $long_key;
		if(isset($meta_arr['after_share_enable']) && $meta_arr['after_share_enable']==1){
	...
	if(strpos($meta_arr['list'], 'baidu')!==FALSE){
		...
		$args = array();
		$args['link'] = 'http://cang.baidu.com/do/add?it=' . $attr['url'] . '&fr=&dc=';
		$args['new_window'] = true;
		$args['sm_type'] = $key;
		$args['sm_class'] = $long_key;
		if(isset($meta_arr['after_share_enable']) && $meta_arr['after_share_enable']==1){
