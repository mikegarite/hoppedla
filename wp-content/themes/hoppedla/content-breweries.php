      ...
      <?php while ( have_posts() ) : the_post(); ?>
        ...
        <div class="container target">
                <div class="row">
                   <div class="col-sm-2">
                        <a href="/users">
                          <img title="profile image" class="img-circle img-responsive" src="<?php echo get_post_meta($post->ID, '_hl_brewery_image', true); ?>"/>
                        </a>
                    </div>
                    <div class="col-sm-10">
            ...
            <script>
              ...
              jQuery.ajax({
                ...
                success: function(data) {
                  console.log(data);
                    var brewery_url = 'https://api.untappd.com/v4/venu/info/'+venue_id+'?client_id=ba87167981fb4eff95cdbda7f1019d1a&client_secret=31a111876e0fb9f738c9aa4347348b39';
