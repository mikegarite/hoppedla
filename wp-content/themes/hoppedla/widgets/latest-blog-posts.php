...
class Pyre_Latest_Blog_Media_Widget extends WP_Widget {
	...
	function Pyre_Latest_Blog_Media_Widget()
	{
		...
		$this->WP_Widget('pyre_homepage_media-widget', 'Home: Blog Posts', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		$defaults = array('title' => 'Latest News', 'summary_text' => '', 'categories' => 'all', 'posts' => 3, 'columns' => 3, 'link_text' => '', 'link_link' => '', 'widget_bg' => '#eeeeee', 'widget_bg_img' => '', 'checkbox_pro' => '1', 'link_icon' => '');
