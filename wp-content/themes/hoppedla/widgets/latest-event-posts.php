...
class Pyre_Latest_Portfolio_Media_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'pyre_homepage_media-port', 'description' => 'Latest Event Posts');
		...
		$this->WP_Widget('pyre_homepage_media-widget-port', 'Home: Event Posts ', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		$defaults = array('title' => 'Events', 'summary_text' => '', 'posts' => 4, 'columns' => 4, 'portfolioslug' => '', 'link_text' => '', 'link_link' => '', 'widget_bg' => '#2f2a24', 'widget_bg_img' => '', 'checkbox_pro' => '1', 'link_icon' => '');
		...
		<p>
			<label for="<?php echo $this->get_field_id('portfolioslug'); ?>"><?php _e( 'Event Category Slug<br>(Leave blank to pull all posts)', 'progression' ); ?>:</label>
