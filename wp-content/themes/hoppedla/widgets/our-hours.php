...
class Our_Hours_Widget extends WP_Widget {
	...
	function Our_Hours_Widget()
	{
		...
		$this->WP_Widget('our-hours-widget', 'Progression: Opening Hours', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		if($title) {
			...
			<ul class="open-hours">
				<li>
					<div class="date-day grid2column-progression"><?php _e( 'Monday', 'progression' ); ?></div><div class="hours-date grid2column-progression lastcolumn-progression"><?php echo esc_attr( $mon_date ); ?></div><div class="clearfix"></div>
				</li>
				<li>
					<div class="date-day grid2column-progression"><?php _e( 'Tuesday', 'progression' ); ?></div><div class="hours-date grid2column-progression lastcolumn-progression"><?php echo esc_attr( $tues_date ); ?></div><div class="clearfix"></div>
				</li>
				<li>
					<div class="date-day grid2column-progression"><?php _e( 'Wednesday', 'progression' ); ?></div><div class="hours-date grid2column-progression lastcolumn-progression"><?php echo esc_attr( $weds_date ); ?></div><div class="clearfix"></div>
				</li>
				<li>
					<div class="date-day grid2column-progression"><?php _e( 'Thursday', 'progression' ); ?></div><div class="hours-date grid2column-progression lastcolumn-progression"><?php echo esc_attr( $thurs_date ); ?></div><div class="clearfix"></div>
				</li>
				<li>
					<div class="date-day grid2column-progression"><?php _e( 'Friday', 'progression' ); ?></div><div class="hours-date grid2column-progression lastcolumn-progression"><?php echo esc_attr( $fri_date ); ?></div><div class="clearfix"></div>
				</li>
				<li>
					<div class="date-day grid2column-progression"><?php _e( 'Saturday', 'progression' ); ?></div><div class="hours-date grid2column-progression lastcolumn-progression"><?php echo esc_attr( $sat_date ); ?></div><div class="clearfix"></div>
				</li>
				<li>
					<div class="date-day grid2column-progression"><?php _e( 'Sunday', 'progression' ); ?></div><div class="hours-date grid2column-progression lastcolumn-progression"><?php echo esc_attr( $sun_date ); ?></div><div class="clearfix"></div>
				</li>
			</ul>
	...
	{
		$defaults = array('title' => 'Opening Hours', 'mon_date' => '', 'tues_date' => '', 'weds_date' => '', 'thurs_date' => '', 'fri_date' => '', 'sat_date' => '', 'sun_date' => '');
